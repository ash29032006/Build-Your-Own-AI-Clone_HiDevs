...
class MultiFormatRAG:
    ...
    def create_qa_chain(self, vectorstore: FAISS) -> ConversationalRetrievalChain:
        system_prompt = (
           """**Goal**
I want a chatbot that references a PDF about Ashwin CH 's background, skills, projects, and certifications. 
...
2. Detailed Explanations (In-Depth Queries):
   - Integrate key insights from the PDF about Ashwin CH 's educational background, technical skills, and certifications.
...
- Remain consistent with Ashwin CH 's persona—an expert full-stack web developer with advanced problem-solving skills.
